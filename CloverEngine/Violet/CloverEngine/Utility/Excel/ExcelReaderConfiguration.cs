...
namespace Clover
{
    ...
    public class ExcelReaderConfiguration
    {
        ...
        /// </summary>
        public char[] AutodetectSeparators { get; } = DefaultSpliter;
        ...
        public static ExcelReaderConfiguration Default()
        {
            ExcelReaderConfiguration configuration = new ExcelReaderConfiguration();
            configuration.FallbackEncoding = Encoding.UTF8;
            configuration.Password = string.Empty;
            configuration.LeaveOpen = false;

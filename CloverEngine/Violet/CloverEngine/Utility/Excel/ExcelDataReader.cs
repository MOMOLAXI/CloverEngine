...
namespace Clover
{
        ...
        where TWorksheet : IWorksheet
    {
        ...
        public double GetColumnWidth(int i)
        {
            ...
            Column[] columnWidths = _worksheetIterator?.Current?.ColumnWidths ?? null;
            double? retWidth = null;
            if (columnWidths != null)
            {
                foreach (Column columnWidth in columnWidths)
                {
        ...
        public CellStyle GetCellStyle(int i)
        {
            ...
            ExtendedFormat effectiveStyle = RowCells[i].EffectiveStyle;
        ...
        private IEnumerable<TWorksheet> ReadWorksheetsWithCache()
        {
            ...
            {
                foreach (TWorksheet worksheet in _cachedWorksheets)
                {
        ...
        private void ReadCurrentRow()
        {
            ...
            foreach (Cell cell in _rowIterator.Current.Cells)
            {

                ...
                case SheetFormatPr: // BrtWsFmtInfo 
                    {
                        ...
                        bool unsynced = (buffer[8] & 0b1000) != 0;
                ...
                case HeaderFooter: // BrtBeginHeaderFooter 
                    {
                        ...
                        uint offset = 2;
                        string? header = GetNullableString(buffer, ref offset);
                        string? footer = GetNullableString(buffer, ref offset);
                        string? headerEven = GetNullableString(buffer, ref offset);
                        string? footerEven = GetNullableString(buffer, ref offset);
                        string? headerFirst = GetNullableString(buffer, ref offset);
                        string? footerFirst = GetNullableString(buffer, ref offset);

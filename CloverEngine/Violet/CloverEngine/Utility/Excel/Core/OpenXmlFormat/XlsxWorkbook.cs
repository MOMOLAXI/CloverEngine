...
namespace Clover
{
    internal class XlsxWorkbook : CommonWorkbook, IWorkbook<XlsxWorksheet>
    {
        ...
        {
            foreach (SheetRecord sheet in Sheets)
            {
        ...
        {
            using Stream stream = _zipWorker.GetWorkbookRelsStream();
            if (stream == null)
            {
                return;
            }
        ...
        {
            using RecordReader reader = _zipWorker.GetSharedStringsReader();
            if (reader == null)
                return;
        ...
        {
            using RecordReader reader = _zipWorker.GetStylesReader();
            if (reader == null)
                return;

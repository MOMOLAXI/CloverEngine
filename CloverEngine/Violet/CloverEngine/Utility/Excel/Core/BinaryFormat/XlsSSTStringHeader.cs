...
namespace Clover
{
    ...
    internal class XlsSSTStringHeader
    {
        ...
        /// </summary>
        public ushort CharacterCount => BitConverter.ToUInt16(m_Bytes, m_Offset);

        /// <summary>
        /// Gets the flags.
        /// </summary>
        public FormattedUnicodeStringFlags Flags => (FormattedUnicodeStringFlags) Buffer.GetByte(m_Bytes, m_Offset + 2);

        /// <summary>
        /// Gets a value indicating whether the string has an extended record. 
        /// </summary>
        public bool HasExtString => (Flags & FormattedUnicodeStringFlags.HasExtendedString) ==
                                    FormattedUnicodeStringFlags.HasExtendedString;

        /// <summary>
        /// Gets a value indicating whether the string has a formatting record.
        /// </summary>
        public bool HasFormatting => (Flags & FormattedUnicodeStringFlags.HasFormatting) ==
                                     FormattedUnicodeStringFlags.HasFormatting;
        ...
        public uint ExtendedStringSize =>
            HasExtString ? (uint) BitConverter.ToUInt32(m_Bytes, (int) m_Offset + (HasFormatting ? 5 : 3)) : 0;

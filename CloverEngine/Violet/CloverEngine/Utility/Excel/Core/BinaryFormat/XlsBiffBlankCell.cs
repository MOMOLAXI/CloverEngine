    ...
    internal class XlsBiffBlankCell : XlsBiffRecord
    {
        ...
        public bool IsBiff2Cell
        {
            get
            {
                return Id switch
                {
                    BIFFRECORDTYPE.NUMBER_OLD => true,
                    BIFFRECORDTYPE.INTEGER_OLD => true,
                    BIFFRECORDTYPE.LABEL_OLD => true,
                    BIFFRECORDTYPE.BLANK_OLD => true,
                    BIFFRECORDTYPE.BOOLERR_OLD => true,
                    _ => false
                };
            }
        }
